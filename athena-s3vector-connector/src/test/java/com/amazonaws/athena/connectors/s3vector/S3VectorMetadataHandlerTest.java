...
public class S3VectorMetadataHandlerTest
{
    private static final Logger logger = LoggerFactory.getLogger(S3VectorMetadataHandlerTest.class);

    private S3VectorMetadataHandler handler = new S3VectorMetadataHandler(new LocalKeyFactory(),
