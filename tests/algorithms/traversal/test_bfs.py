...
class TestBfsEdges:
    ...
    def test_bfs_edges_with_reverse(self, mock_graph):
        """Test bfs_edges with reverse parameter."""
        source = "A"
        result = list(bfs_edges(mock_graph, source, reverse=True))
    ...
    def test_bfs_edges_with_depth_limit(self, mock_graph):
        """Test bfs_edges with depth_limit parameter."""
        source = "A"
        result = list(bfs_edges(mock_graph, source, depth_limit=2))
