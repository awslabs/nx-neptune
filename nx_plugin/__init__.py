...
def get_info():
    return {
        ...
        "short_summary": "Neptune Analytics computation backend.",
        "description": "Scale graph algorithms on AWS Neptune Analytics platform.",
        "functions": {
            "asyn_lpa_communities": {
                "additional_docs": """Please note that the seed parameter is not supported at the moment,
                ...
                "extra_parameters": {
                  ...
                  one of those property values will be sampled at random.""",
                    ...
                    """If `write_property` is specified, the mutated version will be used.
                     In this mode, the algorithm writes the result directly into the remote graph
                     under the specified property name.
                     **Important:** No execution result will be returned to the user in this mode.
                     ...
                     or ensure the option `nx.config.backends.neptune.export_s3_bucket`
                     is properly configured for automatic export.""",
                },
            },
            "bfs_edges": {
                "extra_parameters": {
        ...
        Variant-specific control over the update method (e.g., synchronous vs. asynchronous) is not configurable.""",
            ...
            "louvain_communities": {
                "additional_docs": """Please note that the resolution and seed parameters are not supported at the moment.
                        """,
                "extra_parameters": {
                    "edge_labels : list[str], optional": "A list of edge label strings; "
                    """To filter on one more edge labels, provide a list of the ones to filter on.
                    ...
                    """If `write_property` is specified, the mutation version will be used.
                       In mutation mode, the algorithm writes the result directly into the remote graph
                       under the specified property name.
                       **Important:** No execution result will be returned to the user in mutation mode.
                       To preserve the mutated graph state, you must either avoid setting `write_property`,
                       or ensure the option `nx.config.backends.neptune.export_s3_bucket` is properly configured
            ...
            "pagerank": {
                "additional_docs": """Neptune Analytics recommends using a max_iter value of 20 for PageRank
