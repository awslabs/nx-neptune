...
def fast_label_propagation_communities(
    ...
    *,
    ...
    return run_label_propagation_query(neptune_graph, parameters)
...
def run_label_propagation_query(
    neptune_graph: NeptuneGraph, parameters: dict[str, Any]
):
    """
    Execute labelPropagation algorithm with provided parameters dictionary,
    and parse the response and response in the form of dict_value.
